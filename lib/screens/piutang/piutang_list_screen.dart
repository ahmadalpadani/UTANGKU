...
class PiutangListScreen extends StatefulWidget {
  ...
  @override
  State<PiutangListScreen> createState() => _PiutangListScreenState();
}

class _PiutangListScreenState extends State<PiutangListScreen> {
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => const AddDebtScreen(isUtang: false),
            ),
          );
        },
        backgroundColor: AppTheme.piutangColor,
        child: const Icon(Icons.add),
      ),
      body: Consumer<DebtProvider>(
        builder: (context, provider, child) {
          final allPiutang = provider.piutangList;
          final filteredPiutang = _filterDebts(allPiutang);
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            'Tap tombol + untuk menambah piutang',
  ...
  Widget _buildPiutangCard(BuildContext context, DebtModel debt, DebtProvider provider) {
          ...
          child: Column(
            ...
            children: [
              Row(
                children: [
                  CircleAvatar(
                    backgroundColor: AppTheme.piutangColor.withValues(alpha: 0.1),
                    child: Icon(
                      Icons.arrow_upward,
                ...
                children: [
                  ...
                  Expanded(
                    child: OutlinedButton.icon(
                      ...
                      style: OutlinedButton.styleFrom(
                        foregroundColor: isPaid ? AppTheme.piutangColor : AppTheme.success,
                        side: BorderSide(
                          color: isPaid ? AppTheme.piutangColor : AppTheme.success,
                        ),
                      ),
                    ),
                  ),
  ...
  void _editPiutang(DebtModel debt) {
    Navigator.push(
      context,
      MaterialPageRoute(
